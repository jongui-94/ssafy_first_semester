...
public class BoardRestController {
	...
	@ApiOperation(value = "{no}에 해당하는 게시물 정보를 반환한다.", response = Board.class)
	@GetMapping("/board/{no}")
	...
	@ApiOperation(value = "게시물을 저장한다.", response = Board.class)
	@PostMapping("/board")
	...
	@ApiOperation(value = "{no}에 해당하는 게시물을 수정한다.", response = Board.class)
	@PutMapping("/board/{no}")
	...
	@ApiOperation(value = "{no}에 해당하는 게시물을 삭제한다.", response = Integer.class)
